                ...
                <div class="container">
                    <div class="row">
                        <div class="slide-text <?php if($row['position'] == 'Left') {echo 'slide_style_left';} elseif($row['position'] == 'Center') {echo 'slide_style_center';} elseif($row['position'] == 'Right') {echo 'slide_style_right';} ?>">
                            ...
                            <a href="<?php echo $row['button_url']; ?>" target="_blank"  class="btn btn-primary" style="background-color:#13a31e;" data-animation="animated <?php if($row['position'] == 'Left') {echo 'fadeInLeft';} elseif($row['position'] == 'Center') {echo 'fadeInDown';} elseif($row['position'] == 'Right') {echo 'fadeInRight';} ?>"><?php echo $row['button_text']; ?></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="product-carousel">
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <img class="image" src="assets/uploads/<?php echo $row['p_featured_photo']; ?>" alt="" place-items="center">
                            </div><hr>
                            <div class="text">
                                <div class="name">
                                ...
                                <?php else: ?>
                                    ...
                                    <a href=""><i class="fa fa-shopping-cart"> Buy</i></a>
                                    </div>
